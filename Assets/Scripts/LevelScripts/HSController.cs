...
public class HSController : MonoBehaviour
{
    ...
    public string addScoreURL = "http://www.skypyre.com/HalenScore/addscore.php?"; //be sure to add a ? to your url
    public string highscoreURL = "http://www.skypyre.com/HalenScore/display.php";
